...
What a Waste is a global project to aggregate data on solid waste management from around the world. This database features the statistics collected through the effort, covering nearly all countries and over 330 cities. Beyond waste generation, there are a long list of additional indicators in this dataset.
...
# here::here calls the function directly from a package without needing to load
# the whole package
...
ggplot(data = global_waste_data_kg_year,
       mapping = aes(x = gdp,
                     ...
                     shape = income_id)) +
  geom_point() +
  scale_y_continuous(breaks = seq(0, 1400, 200), limits = c(0, 1400)) + # scales(min,max,steps)
